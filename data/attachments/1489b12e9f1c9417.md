...
- Name: auth/login.spec.js >> Authentication - Login >> TC-LOGIN-03 - wrong password for a registered email is rejected @regression
...
Expected substring: "Email and Password Doesn't match"
  ...
  - generic [ref=e20]:
    ...
    - generic [ref=e23]:
      - generic [ref=e25]:
        ...
        - textbox "Enter Password" [ref=e28]: WrongPassword@999
